...
// echo $nombreEmpresa . " " . $idDxInicial;
// die();
...
$crear = $objEmpresasDx1->crearDx2($idDxInicial, $nombreEmpresa, $nit, $sectorEconomico, $nombreRepresentante, $email,  
