const si7_1 = document.getElementById("si7_1");
const no7_1 = document.getElementById("no7_1");
const si7_2 = document.getElementById("si7_2");
const no7_2 = document.getElementById("no7_2");
const si7_3 = document.getElementById("si7_3");
const no7_3 = document.getElementById("no7_3");
const si7_4 = document.getElementById("si7_4");
const no7_4 = document.getElementById("no7_4");
const si7_5 = document.getElementById("si7_5");
const no7_5 = document.getElementById("no7_5");


const siete_uno_dos=document.getElementById("siete_uno_dos");
const siete_uno_tres=document.getElementById("siete_uno_tres");
const siete_dos_dos=document.getElementById("siete_dos_dos");
const siete_dos_tres=document.getElementById("siete_dos_tres");
const siete_tres_dos=document.getElementById("siete_tres_dos");
const siete_tres_tres=document.getElementById("siete_tres_tres");
const siete_cuatro_dos=document.getElementById("siete_cuatro_dos");
const siete_cuatro_tres=document.getElementById("siete_cuatro_tres");
const siete_cinco_dos=document.getElementById("siete_cinco_dos");
const siete_cinco_tres=document.getElementById("siete_cinco_tres");
