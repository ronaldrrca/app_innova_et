...
<body>
    ...
    <main id="main-diagnosticoFinal">
        <section id="diagnosticoIni-container">
            ...
            <form id="diagnosticoIni-form" action="../../controlador/diagnosticoFinalControlador.php" method="POST">
                <input hidden type="text" name="idDxInicial" value="<?php echo $_GET['idDxInicial'] ?>">
                <label for="nombreEmpresa">Nombre de la empresa</label>
                <input type="text" name="nombreEmpresa" readonly required value="<?php echo $_GET['empresa'] ?>">
                <label for="nit">Nit</label>
                <input type="number" name="nit" readonly placeholder="Ingrese el nit sin puntos ni guión" value="<?php echo $_GET['nit'] ?>" required>
                <label for="sectorEconomico">Sector económico</label>
                <input type="text" name="sectorEconomico" readonly value="<?php echo $_GET['sectorEconomico'] ?>">
                <label for="nombreRepresentante">Nombre del representante</label>
                <input type="text" name="nombreRepresentante" required value="<?php echo $_GET['representante'] ?>">
                <label for="telefonoContacto">Teléfono de contacto</label>
                <input type="number" name="telefonoContacto" value="<?php echo $_GET['telefono'] ?>" placeholder="Ingrese los 10 dígitos sin espacios ni guión" required>
                <label for="email">Correo electrónico</label>
                <input type="email" name="email" required value="<?php echo $_GET['email'] ?>">
                <label for="paginaWeb">Página web</label>
                <input type="text" name="paginaWeb" value="<?php echo $_GET['paginaWeb'] ?>">
                <label for="plataformaInnovacion">Plataforma de innovacion</label>
                <input type="text" name="plataformaInnovacion" value="<?php echo $_GET['plataformaInnovacion'] ?>">
                ...
                <section class="seccion">
                      ...
                      <div class="ruta-innovacion">
                          <div>
                                ...
                                <input id="si7_1_dx2" type="radio" value="1" name="siete_uno_uno" required>
                          </div>
                          <div>
                                <label for="siete_uno_uno">No</label>
                                <input id="no7_1_dx2" type="radio" value="0" name="siete_uno_uno" required>
                          </div>
                                                        
                        </div>
                          <input id="siete_uno_dos_dx2" type="text" name="siete_uno_dos" placeholder="Descripción iniciativa de innovación">
                          <select name="siete_uno_tres" id="siete_uno_tres_dx2">
                            ...
                            <option value="Validación inicial del mercado">Validación inicial del mercado</option>
                      ...
                      <article class="contenidoModelo2">
                          ...
                          <div>
                                ...
                                <input id="si7_2_dx2" type="radio" value="1" name="siete_dos_uno" required>
                            </div>
                            <div>
                                <label for="siete_dos_uno">No</label>
                                <input id="no7_2_dx2" type="radio" value="0" name="siete_dos_uno" required>
                            </div>
                          </div>
                          
                          <input id="siete_dos_dos_dx2" type="text" name="siete_dos_dos" placeholder="Descripción iniciativa de innovación">
                          <select name="siete_dos_tres" id="siete_dos_tres_dx2">
                      ...
                      <article class="contenidoModelo2">
                          <div class="ruta-innovacion">
                            <div>
                                    ...
                                    <input id="si7_3_dx2" type="radio" value="1" name="siete_tres_uno" required>
                                </div>
                                <div>
                                    <label for="siete_tres_uno">No</label>
                                    <input id="no7_3_dx2" type="radio" value="0" name="siete_tres_uno" required>
                                </div>
                          </div>
                          
                          <input id="siete_tres_dos_dx2" type="text" name="siete_tres_dos" placeholder="Descripción iniciativa de innovación">
                          <select name="siete_tres_tres" id="siete_tres_tres_dx2">
                            <option value="" readonly selected>Fase de la iniciativa</option> 
                            <option value="Ninguna">Ninguna</option>
                            <option value="Identificación de oportunidad">Identificación de oportunidad</option>
                            <option value="Ideación">Ideación</option>
                      ...
                      <article class="contenidoModelo2">
                          <div class="ruta-innovacion">
                              <div>
                                    ...
                                    <input id="si7_4_dx2" type="radio" value="1" name="siete_cuatro_uno" required>
                              </div>
                              <div>
                              <label for="siete_cuatro_uno">No</label>
                                    <input id="no7_4_dx2" type="radio" value="0" name="siete_cuatro_uno" required>
                                    </div>
                          </div>
                          
                          <input id="siete_cuatro_dos_dx2" type="text" name="siete_cuatro_dos" placeholder="Descripción iniciativa de innovación">
                          <select name="siete_cuatro_tres" id="siete_cuatro_tres_dx2">
                            <option value="" readonly selected>Fase de la iniciativa</option> 
                            <option value="Ninguna">Ninguna</option>
                            <option value="Identificación de oportunidad">Identificación de oportunidad</option>
                            <option value="Ideación">Ideación</option>
                      ...
                      <article class="contenidoModelo2">
                          <div class="ruta-innovacion">
                              <div>
                                    ...
                                    <input id="si7_5_dx2" type="radio" value="1" name="siete_cinco_uno" required>    
                              </div>
                              <div>
                                    <label for="siete_cinco_uno">No</label>
                                    <input id="no7_5_dx2" type="radio" value="0" name="siete_cinco_uno" required>
                              </div>
                          </div>
                          
                          <input id="siete_cinco_dos_dx2" type="text" name="siete_cinco_dos" placeholder="Descripción iniciativa de innovación">
                          <select name="siete_cinco_tres" id="siete_cinco_tres_dx2">    
                            <option value="" readonly selected>Fase de la iniciativa</option> 
                            <option value="Ninguna">Ninguna</option>
                            <option value="Identificación de oportunidad">Identificación de oportunidad</option>
                            <option value="Ideación">Ideación</option>
...
<script src="../js/diagnosticoFinal.js"></script>
</html>
